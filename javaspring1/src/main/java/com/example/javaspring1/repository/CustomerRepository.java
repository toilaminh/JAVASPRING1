...
public interface CustomerRepository extends JpaRepository<Customer, Integer> {
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level2.CustomerDto_Ex5_2(c.firstName, c.lastName, COUNT(f.id))\n" +
            "FROM customer c\n" +
            "JOIN c.rentals r ON r.customer.id = c.id\n" +
            "JOIN r.inventory i ON i.id = r.inventory.id\n" +
            "JOIN film_category fc ON fc.film.id = i.film.id\n" +
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level2.CustomerDto_Ex9_2( c.firstName, c.lastName)\n" +
            "FROM customer c\n" +
    ...
    //Level3
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.CustomerDto_Ex3_3(c.firstName, c.lastName, COUNT(f.id), SUM(p.amount))\n" +
            "FROM customer c\n" +
            "JOIN rental r ON r.customer.id = c.id\n" +
            "JOIN inventory i ON i.id = r.inventory.id\n" +
            "JOIN film f ON f.id = i.film.id\n" +
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.CustomerDto_Ex4_3(c.firstName, c.lastName, COUNT(f.id), SUM(p.amount))\n" +
            "FROM customer c\n" +
            "JOIN rental r ON r.customer.id = c.id\n" +
            "JOIN inventory i ON i.id = r.inventory.id\n" +
            "JOIN film f ON f.id = i.film.id\n" +
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.CustomerDto_Ex7_3(c.firstName, c.lastName, COUNT(DISTINCT f.id))\n" +
            "FROM customer c\n" +
            "JOIN rental r ON r.customer.id = c.id\n" +
            "JOIN inventory i ON i.id = r.inventory.id\n" +
            "JOIN film f ON f.id = i.film.id\n" +
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.CustomerDto_Ex9_3(c.firstName, c.lastName)\n" +
            "FROM customer c\n" +
            "JOIN rental r ON r.customer.id = c.id\n" +
            "JOIN inventory i ON i.id = r.inventory.id\n" +
            "JOIN film f ON f.id = i.film.id\n" +
