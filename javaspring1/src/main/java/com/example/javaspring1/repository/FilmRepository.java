...
import com.example.javaspring1.model.dto.sql.level2.FilmDto_Ex10_2;
import com.example.javaspring1.model.dto.sql.level2.FilmDto_Ex3_2;
import com.example.javaspring1.model.dto.sql.level2.FilmDto_Ex8_2;
import com.example.javaspring1.model.dto.sql.level3.FilmDto_Ex5_3;
import com.example.javaspring1.model.dto.sql.level3.FilmDto_Ex8_3;
...
public interface FilmRepository extends CrudRepository<Film, Integer>, JpaRepository<Film, Integer> {
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level2.FilmDto_Ex8_2(f.title)\n" +
            "FROM film f\n" +
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level2.FilmDto_Ex10_2( f.title)\n" +
            "FROM film f\n" +
    ...
    //Level3
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.FilmDto_Ex5_3(f.title, c.firstName, c.lastName, COUNT(f.id))\n" +
            "FROM film f\n" +
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.FilmDto_Ex8_3(f.title, COUNT(f.id))\n" +
            "FROM film f\n" +
            "JOIN inventory i ON i.film.id = f.id\n" +
            "JOIN rental r ON r.inventory.id = i.id\n" +
            "GROUP BY f.id\n" +
