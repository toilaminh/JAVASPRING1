...
//    @Query("SELECT new com.example.javaspring1.model.dto.sql.ActorDto(a.firstName, a.lastName) FROM actor a")
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level2.ActorDto_Ex6_2(a.firstName, a.lastName, SUM(f.rentalRate))\n" +
            "FROM actor a\n" +
            "JOIN a.filmActors fa ON fa.actor.id = a.id\n" +
            "JOIN fa.film f ON f.id = fa.film.id\n" +
            "GROUP BY a.id")
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level2.ActorDto_Ex7_2(a.firstName, a.lastName)\n" +
            "FROM actor a\n" +
            "JOIN a.filmActors fa ON fa.actor.id = a.id\n" +
            "JOIN fa.film f ON f.id = fa.film.id\n" +
    ...
    //Level3
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.ActorDto_Ex1_3(a.firstName, a.lastName, ctg.name, AVG(f.rentalDuration))\n" +
            "FROM actor a\n" +
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.ActorDto_Ex2_3(a.firstName, a.lastName)\n" +
            "FROM actor a\n" +
            "JOIN film_actor fa ON fa.actor.id = a.id\n" +
            "JOIN film f ON f.id = fa.film.id\n" +
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.ActorDto_Ex6_3( a.firstName, a.lastName, COUNT(f.id))\n" +
            "FROM actor a\n" +
            "JOIN film_actor fa ON fa.actor.id = a.id\n" +
            "JOIN film f ON f.id = fa.film.id\n" +
            "WHERE f.id IN (\n" +
    ...
    @Query("SELECT new com.example.javaspring1.model.dto.sql.level3.ActorDto_Ex10_3(a.firstName, a.lastName)\n" +
            "FROM actor a\n" +
            "JOIN film_actor fa ON fa.actor.id = a.id\n" +
            "JOIN film f ON f.id = fa.film.id\n" +
